...
from restify.blueprints import _factory, all_blueprints
...
def test_blueprint_instances():
    ...
    assert all([b.import_name.startswith('restify.views.') for b in all_blueprints])
...
def test_factory():
    ...
    assert 'restify.views.home.index' == bp.import_name
