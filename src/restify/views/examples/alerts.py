...
from restify.core import flash
from restify.blueprints import examples_alerts
    ...
    if message_size == 'large':
        ...
        Traceback (most recent call last):
          ...
          File "/Users/robpol86/virtualenvs/Flask-Large-App/lib/python2.7/site-packages/flask/app.py", line 1410, in handle_exception
            return handler(e)
          File "/Users/robpol86/workspace/Flask-Large-Application-Example/restify/middleware.py", line 56, in error_handler
            send_exception('{} exception in {}'.format(exception_name, view_module))
          File "/Users/robpol86/workspace/Flask-Large-Application-Example/restify/core/email.py", line 77, in send_exception
            mail.send(msg)
